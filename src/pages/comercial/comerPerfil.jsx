...
import { getPerfilProductor } from '../../services/apiComercial/perfilProductor';
...
export default function MiPerfilComercial() {
  ...
  // Carga inicial de datos de la API comercial sin advertencias de renderizado
  useEffect(() => {
    let isMounted = true;
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-6">
          ...
          <div>
            ...
            <span className="bg-[#EAF3E6] text-[#387030] px-3 py-1 rounded-full text-xs font-bold inline-block mt-1">
              {perfil.tipo_productor || 'Productor Comercial'}
            </span>
          </div>
          <div>
