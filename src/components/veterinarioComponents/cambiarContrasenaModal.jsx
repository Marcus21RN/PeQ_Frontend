			...
			<div className="flex w-full max-w-md flex-col overflow-hidden rounded-[22px] bg-white shadow-2xl" onClick={(event) => event.stopPropagation()}>
				...
				<form onSubmit={handleSubmit} className="space-y-5 px-6 py-6">
						...
						<div key={field.key} className="space-y-2">
							...
							<div className="relative">
								<input
									...
									className="w-full rounded-xl border border-gray-300 px-4 py-3 pr-12 text-sm text-[#111827] outline-none transition-colors placeholder:text-gray-400 focus:border-[#2E6B2C] focus:ring-2 focus:ring-[#2E6B2C]/15"
								/>
					...
					<div className="flex gap-3 pt-2">
						...
						<button type="submit" className="flex-1 rounded-xl bg-[#A7C29B] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#8FA984]">
